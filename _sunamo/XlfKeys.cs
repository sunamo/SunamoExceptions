...
{
    internal static readonly string StringHasNotBeenInPathFormat;
    ...
    internal static string CanTDeleteFolder { get; set; }
    internal static string DoesnTHaveRequiredType { get; set; }
    internal static string NotSupported { get; set; }
}
